  ...
  return (
    <article className="vehicle-card">
      ...
      <div className="vehicle-content">
        <div className="vehicle-title-row"><div><p className="vehicle-brand">{vehicle.brand}</p><h3>{vehicle.model}</h3></div><span className="availability-dot"><i />{vehicle.status}</span></div>
        ...
        <div className="vehicle-actions"><Link className="text-link" href="#contatto">Richiedi informazioni <span>↗</span></Link><Link className="text-link subtle" href="#confronta">Confronta</Link></div>
      </div>
    </article>
  );
}
